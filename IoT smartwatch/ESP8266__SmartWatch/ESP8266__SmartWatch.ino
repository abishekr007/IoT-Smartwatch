...
char auth[] = "KeVQ_ki6ZRXY0vFKXNTqJq5nFSDmSqlB"; //Enter your Authentication Token
...
const char* ssid = "Adhitya";   // insert your own ssid
const char* password = "narayan1";              // and password
String date;
String t;
String tempC;
...
BLYNK_CONNECTED() {
  ...
  bridge1.setAuthToken("p6808Co7wnkHp9UUhYnyhqO4d1oogl0S"); // Enter the Auth token of the relay module(Other Esp8266 Module);
}
